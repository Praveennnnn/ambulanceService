...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      location: 'Byatarayanapura, Bangalore',
      duration: '2023 – 2024',
      services: [
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-600 mb-2">20+</div>
              <p className="text-gray-600 font-medium">Major Projects</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 mb-2">5</div>
              <p className="text-gray-600 font-medium">Cities Covered</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-red-600 mb-2">15</div>
              <p className="text-gray-600 font-medium">Ongoing Projects</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-emerald-600 mb-2">100%</div>
